...
/**
 * Legacy deterministic mock signal feed (pre-dates the Strategy Library and
 * Risk Constitution). Kept at /capital/market-signals — not to be confused
 * with the governed Signal Engine at /capital/signals (signal-engine.ts),
 * which derives paper-only recommendations from the selected strategy,
 * market data, portfolio state, and the Risk Constitution.
 */
