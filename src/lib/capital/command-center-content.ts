...
export const LIVE_MARKET_DATA_DISCLOSURE =
  "AOC Capital may use a live, read-only market data feed to price paper positions more realistically and give strategy context. This never enables real trading: no broker or exchange is connected, no trading credentials are stored or requested, and no order is ever placed, prepared, signed, or routed.";
...
export const GUIDED_JOURNEY: GuidedJourneyStep[] = [
  ...
  },
  {
    ...
    description: "Approved intents open paper positions, marked to a live market price when available, or a deterministic simulated price otherwise.",
...
export const DISCOVERABILITY_LINKS: CommandCenterLink[] = [
  ...
  { href: "/capital/market-data", label: "Market Data", description: "Live-or-simulated price feed used to mark paper positions — read-only, no trading." },
